...
- [Never `git add -A` while other agents write concurrently — stage explicit paths](lessons/never-git-add-all-while-agents-write-concurrently.md) — area:agent-workflow; topic:concurrent-agents,commit-hygiene,staging
